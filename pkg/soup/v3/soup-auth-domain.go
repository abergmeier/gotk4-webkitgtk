...
// AuthDomain class managing authentication for Server.
...
//
// You can also add paths by setting the SoupAuthDomain:add-path property,
...
//
// You can also remove paths by setting the SoupAuthDomain:remove-path property,
// which can also be used to remove one or more paths at construct time.
//
// The function takes the following parameters:
//
...
// SoupAuthDomain:filter-data properties, which can also be used to set the
