...
const (
	...
	// ownership of it and free it with g_free().
	MemoryTake
...
// Likewise, for server-side messages, the request body is automatically filled
// in after being read.
//
...
//
//   - bytes containing the same data as body. (You must g_bytes_unref() this if
//     you do not want it.).
//
...
// Chunk gets a #GBytes containing data from body starting at offset. The size
...
// soup_message_body_append_bytes(), but if you have set body's accumulate flag
