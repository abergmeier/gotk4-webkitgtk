...
// ServerMessage class represnting an HTTP request and response pair for a
// server.
...
// message.
//
// Note that this signal is not parallel to ServerMessage::got-chunk; it is
// emitted only when a complete chunk (added with soup_message_body_append()
// or soup_message_body_append_bytes()) has been written. To get more useful
// continuous progress information, use ServerMessage::wrote-body-data.
...
// ReasonPhrase: get the HTTP reason phrase of msg or NULL.
//
// The function returns the following values:
//
...
// Socket retrieves the #GSocket that msg is associated with.
//
...
// value and reason_phrase is NULL, the reason_phrase will be set automatically.
//
// The function takes the following parameters:
//
