...
// URIComponent: enum values passed to soup_uri_copy() to indicate the
// components of the URI that should be updated with the given values.
...
//
//   - contentType (optional): location to store content type, or NULL.
