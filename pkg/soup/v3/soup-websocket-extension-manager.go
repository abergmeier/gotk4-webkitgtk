...
//
// A SoupWebsocketExtensionManager is added to the session by default,
// and normally you don't need to worry about it at all. However, if you want
// to disable WebSocket extensions, you can remove the feature from the session
// with soup_session_remove_feature_by_type(), or disable it on individual
// requests with soup_message_disable_feature().
